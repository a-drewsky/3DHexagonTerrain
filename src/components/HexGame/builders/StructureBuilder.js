...
import StructureBuilderUtilsClass from "./utils/StructureBuilderUtils"

import { SECOND_MINE_CHANCE, THIRD_MINE_CHACE } from '../constants/StructureConstants'
...
export default class StructureBuilderClass {
   ...
   constructor(gameData) {
      ...
      this.structureBuilderUtils = new StructureBuilderUtilsClass(gameData)
