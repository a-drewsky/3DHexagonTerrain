...
export default class HexMapSpriteManagerClass{
    ...
    constructor(hexMapData, camera, images, settings){
        ...
        this.units = new UnitManagerClass(hexMapData, this.tiles.data, camera, images, settings)
        this.structures = new StructureManagerClass(hexMapData, this.tiles.data, camera, images, settings)
    }
