...
export default class HexMapUpdaterClass {
    ...
    constructor(hexMapData, images, settings, renderer, cameraController, camera, canvas) {
        ...
        this.utils = new HexMapControllerUtilsClass(this.hexMapData, camera, canvas, images);
    ...
    updateUnitMining = (unit) => {
        ...
        if (unit.animationCurTime - unit.animationStartTime >= this.mineTime) {
            ...
            console.log(this.hexMapData.resources)
